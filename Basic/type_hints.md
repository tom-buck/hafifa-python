...
אולי בקוד קצר ופשוט זה לא מרגיש כמו בעיה רצינית אבל בפרוייקטים גדולים זה לעלול ליצור בעיות גדולות שלא פשוט לעלות עליהם
...
**תופס שגיאות מוקדם יותר** - יצמצם שגיאות שעלולות להגיע בהפתעה
...
תמשיכו לחקור ותראו שאתם מבינים להגדיר את כול סוגי המשתנים ומבני הנתונים שאתם מכירים (List, Tuple, Set, Dict ... ) והגדרה של סוגים (Type Alias)
